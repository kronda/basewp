...
class backupbuddy_api {
	...
	/* runBackup()
	 *
	 * @param	string|int	$generic_type_of_profile_id		Valid options are: full, db, OR the numeric profile ID number of the profile to run.
	 ...
	 *
	 */
	public static function runBackup( $generic_type_of_profile_id = '', $triggerTitle = 'BB API', $backupMode = '' ) {
		self::_before();
