...
?>
<div class="thrv-leads-widget thrv_wrapper tve_editor_main_content tve_43_set tve_brdr_solid">
    <div class="thrv_wrapper thrv_contentbox_shortcode cb-rounded-corners" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_orange" style="margin: -10px -10px 20px;">
    ...
    <div data-tve-style="1"
         class="thrv_wrapper thrv_lead_generation tve_clearfix tve_black thrv_lead_generation_vertical tve_3"
