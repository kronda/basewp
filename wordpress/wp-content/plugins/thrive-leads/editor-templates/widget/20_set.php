...
?>
<div class="thrv-leads-widget thrv_wrapper tve_editor_main_content tve_20_set tve_brdr_solid">
    ...
    <h2 style="color: #101010; font-size: 34px; margin-top: 25px;margin-bottom: 0;" class="rft tve_p_center">
    ...
    <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_teal">
            <div class="tve_cb_cnt">
                <div data-tve-style="1" class="thrv_wrapper thrv_lead_generation tve_clearfix tve_red thrv_lead_generation_vertical tve_2" data-inputs-count="3" style="margin-top: 0;margin-bottom: 0;">
