...
?>
<div class="thrv-leads-widget thrv_wrapper tve_editor_main_content tve_41_set tve_brdr_solid">
    <div class="thrv_wrapper thrv_contentbox_shortcode cb-rounded-corners" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_white" style="margin: -10px -10px 20px;">
            <div class="tve_cb_cnt">
                <div style="width: 235px;" class="thrv_wrapper tve_image_caption aligncenter">
                     <span class="tve_image_frame">
                        <img class="tve_image"
                             src="<?php echo TVE_LEADS_URL . 'editor-templates/_form_css/images/set_41_icon.png' ?>"
                             style="width: 235px;"/>
                    </span>
                </div>
                <h2 style="color: #273339; font-size: 32px; margin-top: 25px;margin-bottom: 15px;" class="rft tve_p_center">
    ...
    <div data-tve-style="1"
         class="thrv_wrapper thrv_lead_generation tve_clearfix tve_red thrv_lead_generation_vertical tve_3"
        ...
        <div class="thrv_lead_generation_container tve_clearfix">
            <div class="tve_lead_generated_inputs_container tve_clearfix">
                ...
                <div class="tve_lg_input_container  tve_lg_3 tve_lg_input">
                    <input type="text" name="name" value="" data-placeholder="email" placeholder="Email">
                </div>
