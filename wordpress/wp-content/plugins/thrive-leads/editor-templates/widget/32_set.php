...
?>
<div class="thrv-leads-widget thrv_wrapper tve_editor_main_content tve_32_set tve_brdr_dashed">
    ...
    <h2 style="color: #343035; font-size: 32px; margin-top: 25px;margin-bottom: 15px;" class="rft tve_p_center">
        Best Tips for Online Business
    </h2>

    <p style="color: #343035; font-size: 18px; margin-top: 0;" class="tve_p_center">
        Aenean sollicitudin, lorem quis bibendum auctor, nisi elit
        ipsum, nec sagittis sem nibh id elit.
    </p>
    <div data-tve-style="1"
         class="thrv_wrapper thrv_lead_generation tve_clearfix tve_black thrv_lead_generation_vertical tve_2"
