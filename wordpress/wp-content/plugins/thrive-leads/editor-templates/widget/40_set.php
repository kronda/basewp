...
?>
<div class="thrv-leads-widget thrv_wrapper tve_editor_main_content tve_40_set tve_brdr_solid">
    <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_white">
            <div class="tve_cb_cnt">
                ...
                <h2 style="color: #333; font-size: 32px; margin-top: 25px;margin-bottom: 25px;" class="rft tve_p_center">
