...
?>
<div class="thrv-leads-widget thrv_wrapper tve_editor_main_content tve_30_set tve_brdr_solid">
    <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_purple" style="margin: -10px -10px 10px -10px;">
