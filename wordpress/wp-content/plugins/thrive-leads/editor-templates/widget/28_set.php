...
?>
<div class="thrv-leads-widget thrv_wrapper tve_editor_main_content tve_28_set tve_brdr_solid">
    <h2 style="color: #fff; font-size: 32px; margin-top: 20px;margin-bottom: 10px;" class="rft tve_p_center">
    ...
    <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_blue" style="margin: 40px -10px -10px -10px;">
