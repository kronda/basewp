...
?>
<div class="thrv-leads-form-box tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_editor_main_content tve_40_set tve_brdr_solid tve_blue">
    <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_white">
            <div class="tve_cb_cnt">
                <div class="thrv_wrapper thrv_columns tve_clearfix">
                    <div class="tve_colm tve_foc tve_df tve_ofo ">
                        <div style="width: 179px;" class="thrv_wrapper tve_image_caption aligncenter">
                             <span class="tve_image_frame">
                                <img class="tve_image"
                                     src="<?php echo TVE_LEADS_URL . 'editor-templates/_form_css/images/set_40_icon.png' ?>"
                                     style="width: 179px;"/>
                            </span>
                        </div>
                    </div>
                    <div class="tve_colm tve_tfo tve_df tve_lst">
                        ...
                        <div data-tve-style="1"
                             ...
                             data-inputs-count="2" style="margin-top: 40px;margin-bottom: 0;">
