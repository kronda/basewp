...
?>
<div class="thrv-leads-form-box tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_editor_main_content tve_43_set tve_brdr_solid tve_white">
    <div class="thrv_wrapper thrv_contentbox_shortcode cb-rounded-corners" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_orange" style="margin: -20px -20px 20px;">
