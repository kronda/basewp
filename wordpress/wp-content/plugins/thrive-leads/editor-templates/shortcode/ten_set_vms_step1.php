...
?>
<div
    class="thrv-leads-form-box tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_editor_main_content tve_ten_set_vms_step1 tve_teal tve_brdr_solid">
    <h2 style="color: #fff; font-size: 53px; margin-top: 0;margin-bottom: 40px;" class="tve_p_center rft">Want More
        <span class="bold_text">Email Subscribers?</span></h2>

    <div class="thrv_wrapper thrv_columns" style="margin-top: 60px;margin-bottom: 0;">
        <div class="tve_colm tve_twc">
            ...
            <div style="width: 160px; margin-top: 0;margin-bottom: 0;"
