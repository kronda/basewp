...
<div
    ...
    <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 45px;">
        ...
        <div class="tve_colm tve_tth tve_lst">
            <h4 class="rft" style="color: #667b81; font-size: 36px;margin-top: 20px;margin-bottom: 10px;">Morning
                Kickstart:</h4>

            <p style="color: #666666; font-size: 18px; margin-top: 0;margin-bottom: 20px;">Learn how to adopt the
                morning routines of the world's most productive people.</p>
