...
?>
<div
    class="thrv-leads-form-box tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_editor_main_content tve_nine_set_vms_step2 tve_white tve_brdr_solid">
    <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_teal" style="margin: -20px -20px 0 -20px;">
            <div class="tve_cb_cnt">
                <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 40px;">
                    ...
                    <div class="tve_colm tve_tth tve_lst">
                        ...
                        <p style="color: #fff; font-size: 20px;margin-top: 0;margin-bottom: 20px;">Sign up below to get
                            instant access to our freebie and receive our 5-day list building course for your online
                            business:</p>
                    </div>
                </div>
            </div>
    ...
    <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_blue"
             style="margin: 0 -20px -20px -20px;padding-left: 30px;padding-right: 30px;">
            <div class="tve_cb_cnt">
                <div
