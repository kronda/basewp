...
<div class="thrv-leads-form-box tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_editor_main_content tve_four_set tve_purple">
    <div class="thrv_wrapper thrv_columns" style="margin-top: 0px !important;">
        <div class="tve_colm tve_foc tve_df tve_fft"><div class="thrv_wrapper thrv_icon aligncenter" style="font-size: 40px; border-radius: 0px;">
        ...
        <div class="tve_colm tve_foc tve_df tve_fft tve_lst"><div class="thrv_wrapper thrv_icon aligncenter" style="font-size: 40px; border-radius: 0px;">
                <span data-tve-icon="icon-lock" class="tve_sc_icon four-set-icon-lock" style="padding: 0px; border-radius: 0px; color: #fff"></span>
            </div></div>
    </div><p data-default="Enter your text here..." class="tve_p_center" style="color: rgb(255, 255, 255); font-size: 18px;" contenteditable="false"><span class="tve_custom_font_size" style="font-size: 24px;">Enter your details below to get instant access<br>to this premium content post:</span></p>
        ...
        <div class="thrv_lead_generation_container tve_clearfix">
            <div class="tve_lead_generated_inputs_container tve_clearfix">
                ...
                <div class="tve_lg_input_container  tve_lg_2 tve_lg_input">
                    <input name="name" value="" data-placeholder="Full Name" placeholder="Full Name" type="text">
                </div>
