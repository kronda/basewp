<div class="thrv-greedy-ribbon tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_gr_four_set tve_green">
    <div class="tve-greedy-ribbon-content tve_editor_main_content">
        <h2 class="tve_p_center rft" style="color: #fff; font-size: 65px;margin-top: 0;margin-bottom: 50px;">
            <span class="bold_text">Double</span> your conversion rate
            with a mat-style form
        </h2>

        <div class="thrv_wrapper thrv_content_container_shortcode">
            <div class="tve_clear"></div>
            <div class="tve_center tve_content_inner" style="width: 750px;min-width:50px; min-height: 2em;">
                <p class="tve_p_center" style="color: #fff; font-size: 22px;margin-top: 0;margin-bottom: 80px;">
                    ...
                    <div class="tve_btn tve_btn3 tve_nb tve_green tve_normalBtn">
                        <a class="tve_btnLink tve_evt_manager_listen tve_et_click" href=""
                           data-tcb-events="|open_state_2|">
                            ...
                            <span class="tve_btn_txt">SHOW ME HOW</span>
                        </a>
                    </div>
                </div>
            </div>
