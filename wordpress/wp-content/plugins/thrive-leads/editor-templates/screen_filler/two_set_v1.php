...
<div class="thrv-leads-screen-filler tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_two_set_v1 tve_white">
    <div class="tve-screen-filler-content tve_editor_main_content">
        ...
        <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;">
            <div class="tve_colm tve_foc tve_df tve_ofo ">
                <div style="width: 250px;" class="thrv_wrapper tve_image_caption aligncenter">
             <span class="tve_image_frame">
                <img class="tve_image"
                     src="<?php echo TVE_LEADS_URL . 'editor-templates/_form_css/images/set_two_screenfiller_product.png' ?>"
                     style="width: 250px"/>
            </span>
                </div>
            </div>
            <div class="tve_colm tve_tfo tve_df tve_lst">
                <h2 class="rft" style="color: #78ac49; font-size: 60px;line-height: 70px; margin-top: 20px;margin-bottom: 0;;">GET INSTANT ACCESS</h2>

                <h3 class="rft" style="color: #333333; font-size: 48px; line-height: 50px;margin-top: 0;margin-bottom: 15px;">to Our Awesome Product now!</h3>
        ...
        <div data-tve-style="1"
             class="thrv_wrapper thrv_lead_generation tve_clearfix tve_green tve_draggable thrv_lead_generation_vertical tve_3" data-inputs-count="3"
                ...
                <div class="tve_lead_generated_inputs_container tve_clearfix">
                    ...
                    <div class="tve_lg_input_container  tve_lg_3 tve_lg_input">
                        <div class="thrv_wrapper thrv_icon tve_brdr_solid">
                            <span class="tve_sc_icon two-set-user tve_white" data-tve-icon="two-set-user" style="color: #b1b1b1;"></span>
                        </div>
                        <input type="text" name="name" value="" data-placeholder="Name" placeholder="Name">
                    </div>
                    <div class="tve_lg_input_container tve_lg_3 tve_lg_input">
                        <div class="thrv_wrapper thrv_icon tve_brdr_solid">
                            <span class="tve_sc_icon two-set-envelope tve_white" data-tve-icon="two-set-envelope" style="color: #b1b1b1;"></span>
                        </div>
