...
<div
    class="thrv-leads-screen-filler tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_fifteen_set_vms_step3 tve_white"
    ...
    <div class="tve-screen-filler-content tve_editor_main_content">
        ...
        <h2 class="tve_p_center rfs rft" style="color: #fff; font-size: 60px;margin-top: 0;margin-bottom: 0;">
            <span class="bold_text">COURSE 2:</span> BURN BODY FAT
        </h2>
        ...
        <h5 class="tve_p_center" style="color: #fff; font-size: 28px;margin-top: 0;margin-bottom: 20px; ">
            Enter your email address below and <span class="bold_text">Start BURNING FAT!!!</span>
        </h5>

        <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
            <div class="tve_cb tve_cb5 tve_teal" style="margin-top: 40px;margin-bottom: 40px;">
                <div class="tve_cb_cnt">
                    <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
                        <div class="tve_colm tve_oth">
                            <div class="thrv_wrapper thrv_icon aligncenter tve_brdr_solid"
                                 style="">
                        <span data-tve-icon="fifteen-set-icon-burnfat"
                              class="tve_sc_icon fifteen-set-icon-burnfat tve_teal"
        ...
        <p class="tve_p_center" style="color: #fff; font-size: 22px;margin-top: 0;margin-bottom: 0;">
            <span class="italic_text">
                " Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis id elit. "  <span
                    class="bold_text">-Marc Stevens,</span> <font color="#1dc7c5">Developer</font>
            </span>
        </p>
    </div>
