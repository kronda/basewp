...
<div
    class="thrv-leads-screen-filler tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_53_set_vms_step1 tve_white" style="background-image: url('<?php echo TVE_LEADS_URL . "editor-templates/_form_css/images/set_53_pattern.jpg" ?>');background-repeat: repeat">
    <div class="tve-screen-filler-content tve_editor_main_content">
        <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
            ...
            <div class="tve_colm tve_tth tve_lst">
                <h2 style="color: #333333; font-size: 40px;margin-top: 60px;margin-bottom: 30px;" class="rft">
