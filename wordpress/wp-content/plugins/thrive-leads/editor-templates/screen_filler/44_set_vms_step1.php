...
<div
    class="thrv-leads-screen-filler tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_44_set_vms_step1 tve_green">
            ...
            <div class="tve_cb tve_cb5 tve_white" style="margin: -20px -20px 0 -20px;">
                <div class="tve_cb_cnt">
                    <h2 class="tve_p_center rft"
                        style="color: #333333; font-size: 30px;margin-top: 20px;margin-bottom: 30px;">
                ...
                <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-bottom: 0;margin-top: 40px;">
                    <div class="tve_colm tve_tth">
                        <p style="color: #bae5c5; font-size: 20px;margin-top: 0;margin-bottom: 20px;">
                            Learn how FAST and EASY it is to build a great looking landing page, that generates more
                            leads
                            by using my favourite tools and techniques.
                        </p>
