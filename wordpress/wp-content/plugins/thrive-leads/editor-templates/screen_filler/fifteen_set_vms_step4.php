...
<div
    class="thrv-leads-screen-filler tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_fifteen_set_vms_step4 tve_white"
    ...
    <div class="tve-screen-filler-content tve_editor_main_content">
        ...
        <h2 class="tve_p_center rfs rft" style="color: #fff; font-size: 60px;margin-top: 0;margin-bottom: 0;">
            <span class="bold_text">COURSE 3:</span> GET STRONG
        </h2>
        ...
        <h5 class="tve_p_center" style="color: #fff; font-size: 28px;margin-top: 0;margin-bottom: 20px; ">
            Enter your email address below and <span class="bold_text">GET STRONG!!!</span>
        </h5>
                    ...
                    <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
                        <div class="tve_colm tve_oth">
                            <div class="thrv_wrapper thrv_icon aligncenter tve_brdr_solid"
                                 style="">
                        <span data-tve-icon="fifteen-set-icon-getstrong"
                              class="tve_sc_icon fifteen-set-icon-getstrong tve_teal"
