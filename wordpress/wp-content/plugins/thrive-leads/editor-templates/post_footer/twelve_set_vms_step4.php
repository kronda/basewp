...
<div
    ...
    <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 45px;">
        ...
        <div class="tve_colm tve_tth tve_lst">
            <h4 class="rft" style="color: #667b81; font-size: 36px;margin-top: 20px;margin-bottom: 10px;">The Focus
                Key:</h4>

            <p style="color: #666666; font-size: 18px; margin-top: 0;margin-bottom: 20px;">The strategy for discovering
                what you're best at and doing more of it.</p>
