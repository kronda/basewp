...
?>
<div
    class="thrv-leads-form-box tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_editor_main_content tve_48_set_vms_step1 tve_green tve_brdr_solid">
                    ...
                    <div class="tve_cb_cnt">
                        <div class="thrv_wrapper thrv_content_container_shortcode set-48-contentcontainer">
                            ...
                            <div class="tve_right tve_content_inner"
                                 style="width: 400px;min-width:50px; min-height: 2em;">
                                <h2 style="color: #000000; font-size: 32px; margin-top: 30px;margin-bottom: 25px;"
                                    class="rft">
