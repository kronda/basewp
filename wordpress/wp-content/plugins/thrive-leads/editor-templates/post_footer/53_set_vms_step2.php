...
?>
<div
    class="thrv-leads-form-box tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_editor_main_content tve_53_set_vms_step1 tve_teal tve_brdr_solid"
    style="background-image: url('<?php echo TVE_LEADS_URL . "editor-templates/_form_css/images/set_53_pattern.jpg" ?>'); background-repeat: repeat;">
    <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
        ...
        <div class="tve_colm tve_tth tve_lst">
            <h2 style="color: #333333; font-size: 40px;margin-top: 10px;margin-bottom: 20px;" class="rft">
