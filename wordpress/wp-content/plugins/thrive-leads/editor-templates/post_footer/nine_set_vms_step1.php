 ...
 */
?>
<div class="thrv-leads-form-box tve_no_drag tve_no_icons tve_element_hover thrv_wrapper tve_editor_main_content tve_nine_set_vms_step1 tve_white tve_brdr_solid">
    ...
    <div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
        <div class="tve_cb tve_cb5 tve_blue" style="margin: 0 -20px -20px -20px;">
            <div class="tve_cb_cnt">
