...
<h4 class="tve_p_center" style="color: #fff; font-size: 24px;margin-top: 0;margin-bottom: 20px;">Choose the options that suits your level of skill:</h4>
                ...
                <a class="tve_btnLink tve_evt_manager_listen tve_et_click" href=""
                   data-tcb-events="|open_state_2|">
                        <span class="tve_left tve_btn_im">
                            <i class="tve_sc_icon eleven-set-icon-beginner" style="background-image: none;" data-tve-icon="eleven-set-icon-beginner"></i>
            ...
            <div class="tve_btn tve_nb tve_btn5 tve_normalBtn tve_green">
                <a class="tve_btnLink tve_evt_manager_listen tve_et_click" href=""
                   data-tcb-events="|open_state_3|">
                        <span class="tve_left tve_btn_im">
                            <i class="tve_sc_icon eleven-set-icon-advanced" style="background-image: none;" data-tve-icon="eleven-set-icon-advanced"></i>
                            <span class="tve_btn_divider"></span>
                        </span>
