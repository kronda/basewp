...
<div class="thrv_wrapper thrv_contentbox_shortcode tve_seven_bubble" data-tve-style="6">
    <div class="tve_cb tve_cb6 tve_blue">
        <div class="tve_cb_cnt">
            <p style="color: #fff;font-size: 26px; margin-top: 0;margin-bottom: 0;padding-bottom: 0;">FREE APP</p>
        </div>
    </div>
</div>
<div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
    ...
    <div class="tve_colm tve_tfo tve_df tve_lst">
        <h1 style="color: #333333; font-size: 45px;margin-top: 25px;margin-bottom: 0;">SIGN UP NOW AND DOWNLOAD OUR <span class="bold_text">FREE APP</span> IN SECONDS!</h1>
        ...
        <blockquote style="color: #666666; font-size: 22px;margin-top: 0;margin-bottom: 0;">
            Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit ad
            nunc velit auctor.”
        </blockquote>
    </div>
</div>
<div class="thrv_wrapper thrv_contentbox_shortcode tve_seven_rounded_cb" data-tve-style="5">
    <div class="tve_cb tve_cb5 tve_white" style="margin: 20px -65px -15px -15px;">
        <div class="tve_cb_cnt">
            <div class="thrv_wrapper thrv_columns tve_clearfix" style="margin-top: 0;margin-bottom: 0;">
                <div class="tve_colm tve_foc tve_df tve_ofo">
                    <div style="width: 218px;margin-top: -349px;margin-bottom: -50px;margin-left: -23px;"
