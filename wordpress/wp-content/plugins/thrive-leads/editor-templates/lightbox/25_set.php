...
<div class="thrv_wrapper thrv_contentbox_shortcode" data-tve-style="5">
    <div class="tve_cb tve_cb5 tve_red" style="margin: 40px -16px -40px -16px;">
        <div class="tve_cb_cnt">
            <div data-tve-style="1"
                 class="thrv_wrapper thrv_lead_generation tve_clearfix tve_white thrv_lead_generation_vertical tve_2"
