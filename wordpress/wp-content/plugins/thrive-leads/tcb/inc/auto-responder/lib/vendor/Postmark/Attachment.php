...
class Thrive_Api_Postmark_Attachment implements \JsonSerializable {
	...
	public static function fromRawData($data, $attachmentName, $mimeType = NULL) {
		return new Thrive_Api_Postmark_Attachment(base64_encode($data), $attachmentName, $mimeType);
	}
	...
	public static function fromFile($filePath, $attachmentName, $mimeType = NULL) {
		return new Thrive_Api_Postmark_Attachment(base64_encode(file_get_contents($filePath)), $attachmentName, $mimeType);
	}
