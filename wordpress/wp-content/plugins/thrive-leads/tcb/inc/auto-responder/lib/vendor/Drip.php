...
class Thrive_Api_Drip
{
     ...
     * @return array|bool
     * @throws Exception
     * @throws Thrive_Api_Drip_Exception
     * @throws Thrive_Api_Drip_Exception_Unsubscribed
     */
    ...
    public function make_request($url, $params = array(), $req_method = self::GET)
    {
        ...
        if ($result instanceof WP_Error) {
            throw new Thrive_Api_Drip_Exception($result->get_error_message());
        }
        ...
        if ($httpCode == '422') {
            throw new Thrive_Api_Drip_Exception_Unsubscribed('API call failed. Server returned status code ' . $httpCode . " with message: <b>" . $body['errors'][0]['message'] . "</b>");
        }

        if (!($httpCode == '200' || $httpCode == '201' || $httpCode == '204')) {
            throw new Thrive_Api_Drip_Exception('API call failed. Server returned status code ' . $httpCode . " with message: <b>" . $body['errors'][0]['message'] . "</b>");
        }
