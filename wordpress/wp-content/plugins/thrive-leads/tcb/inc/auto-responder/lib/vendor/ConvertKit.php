...
class Thrive_Api_ConvertKit
{
    ...
    public function __construct($key)
    {
        ...
        if (empty($key)) {
            throw new Thrive_Api_ConvertKit_Exception("Invalid API credentials");
        }
     ...
     *
     * @return array|mixed
     * @throws Thrive_Api_ConvertKit_Exception
     */
    public function getForms()
    {
        ...
        if (isset($forms['error_message'])) {
            throw new Thrive_Api_ConvertKit_Exception($forms['error_message']);
        }
    ...
    public function subscribeForm($form_id, $fields)
    {
        ...
        if (isset($data['status']) && $data['status'] == "created") {
            ...
            throw new Thrive_Api_ConvertKit_Exception($data['status']);
        }
    }
    ...
    protected function _call($path, $args = array(), $method = "GET")
    {
        ...
        if (is_wp_error($request)) {
            throw new Thrive_Api_ConvertKit_Exception('Could not parse the response !');
        } else {
