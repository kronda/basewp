...
class Thrive_Api_Mandrill
{
    ...
    public function __construct($apikey = null)
    {
        ...
        if (!$apikey) throw new Thrive_Api_Mandrill_Exceptions('You must provide a Mandrill API key');
        $this->apikey = $apikey;

        $this->root = rtrim($this->root, '/') . '/';

        $this->templates = new Thrive_Api_Mandrill_Template($this);
        $this->exports = new Thrive_Api_Mandrill_Exports($this);
        $this->users = new Thrive_Api_Mandrill_Users($this);
        $this->rejects = new Thrive_Api_Mandrill_Rejects($this);
        $this->inbound = new Thrive_Api_Mandrill_Inbound($this);
        $this->tags = new Thrive_Api_Mandrill_Tags($this);
        $this->messages = new Thrive_Api_Mandrill_Messages($this);
        $this->whitelists = new Thrive_Api_Mandrill_Whitelists($this);
        $this->ips = new Thrive_Api_Mandrill_Ips($this);
        $this->internal = new Thrive_Api_Mandrill_Internal($this);
        $this->subaccounts = new Thrive_Api_Mandrill_Subaccounts($this);
        $this->urls = new Thrive_Api_Mandrill_Urls($this);
        $this->webhooks = new Thrive_Api_Mandrill_Webhooks($this);
        $this->senders = new Thrive_Api_Mandrill_Senders($this);
        $this->metadata = new Thrive_Api_Mandrill_Metadata($this);
    }
    ...
    public function call($url, $params)
    {
        ...
        $result = thrive_api_remote_post($post_url, array(
            'body' => $params,
            'timeout' => 15,
            'headers' => array(
        ...
        if ($result === null) throw new Thrive_Api_Mandrill_Exceptions('We were unable to decode the JSON response from the Mandrill API: ' . $result['body']);
    ...
    {
        throw new Thrive_Api_Mandrill_Exceptions(json_encode($result));
    }
