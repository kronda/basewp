    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="api" value="webinarjamstudio"/>
            </td>
        </tr>
        <tr>
            <th></th>
            <td><button type="submit" class="tve-button tve-button-green"><?php echo __("Save WebinarJamStudio API Key", "thrive-cb") ?></button></td>
        </tr>
        </tbody>
    </table>
</form>
