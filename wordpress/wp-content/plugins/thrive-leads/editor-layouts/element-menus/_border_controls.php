...
<li class="tve_ed_btn_text clearfix">
    <label class="tve_left" style="color: #878787">
        <input class="tve_change tl-border-width" value="0" type="text" size="3" data-ctrl="function:ext.tve_leads.formBorderWidth" data-css-property="border-width" data-suffix="px"
               data-size="1"> px
    </label>
</li>