 ...
 * classes below.
 */
abstract class Thrive_Leads_ExportData {
    ...
    public function initialize() {
        ...
        switch($this->exportTo) {
            ...
            case 'string':
                ...
                break;
            case 'file':
                $this->tempFile = fopen($this->filename, "w");
                break;
        }
 ...
 */
class ThriveLeadsExportDataTSV extends Thrive_Leads_ExportData {
 ...
 */
class ThriveLeadsExportDataCSV extends Thrive_Leads_ExportData {
 ...
 *  by Oliver Schwarz
 */
class ThriveLeadsExportDataExcel extends Thrive_Leads_ExportData {
