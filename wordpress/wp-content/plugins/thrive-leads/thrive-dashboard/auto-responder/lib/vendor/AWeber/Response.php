...
/**
 * Thrive_Api_AWeber_Response
 *
 * Base class for objects that represent a response from the AWeberAPI.
 * Responses will exist as one of the two Thrive_Api_AWeber_Response subclasses:
 *  - Thrive_Api_AWeber_Entry - a single instance of an AWeber resource
 *  - Thrive_Api_AWeber_Collection - a collection of AWeber resources
 * @uses AWeberAPIBase
 * @package
 * @version $id$
 */
class Thrive_Api_AWeber_Response extends Thrive_Api_AWeber_Base
{
