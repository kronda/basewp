            ...
            <div class="tve_grid tve_landing_pages" id="tve_landing_page_selector">
                <div class="tve_right tve_lb_fields">
                    <input class="tve_keyup tve_lightbox_input" data-ctrl="controls.filter_lp"
                           ...
                           placeholder="<?php echo __('Quick filter...', 'thrive-leads') ?>" value=""
                           id="tve_landing_page_filter">
                </div>
                <div class="tve_scT tve_green">
                    <ul class="tve_clearfix">
                        <li class="tve_tS tve_click"><span
                                class="tve_scTC1"><?php echo __('Opt In Templates', 'thrive-leads') ?></span></li>
                        <li data-ctrl-mousedown="function:ext.tve_leads.template.user_tab_clicked"
                            class="tve_click tve_mousedown"><span
                                class="tve_scTC2"><?php echo sprintf(__('Your Saved %s Templates', 'thrive-leads'), $form_type_name) ?></span>
                        </li>
                        <?php if (!empty($multi_step) && $use_only_screenfiller_templates === false) : ?>
                            <li class="tve_click"><span
                                    class="tve_scTC3"><?php echo __('Multi-step Templates', 'thrive-leads') ?></span>
                            </li>
                        <?php endif ?>
                    </ul>
                        ...
                        <?php if ($current_template) : ?>
                            <div class="tve_lightbox_input_holder">
                                <input type="checkbox" id="tl-user-current-templates"
                                       data-ctrl="function:ext.tve_leads.template.get_saved" class="tve_change"
                                       value="1"/>
                ...
                <div class="tve_landing_pages_actions">
                    <div id="tve-leads-choose-template" class="tve_editor_button tve_editor_button_success tve_right tve_click"
