 ...
 */
class Types_Admin_Edit_Post_Type extends Types_Admin
{
    private $fields;
        ...
        $form['visibility-choose-public'] = array(
            ...
            '#options' => array(
                sprintf(
                    ...
                    __('Visible', 'wpcf'),
                    __('Post Type is public', 'wpcf')
                ) => 'public',
                sprintf(
                    '<span class="title">%s</span> <span class="description">(%s)</span>',
                    __('Hidden', 'wpcf'),
                    __('users cannot directly edit data in this Post Type', 'wpcf')
                ) => 'hidden',
            ),
 ...
 <a href="#visibility" class="cancel-post-visibility hide-if-no-js button-cancel">Cancel</a>
    ...
    {
        if ( 'types_page_wpcf-edit-type' != $screen_base ) {
            return;
        }
