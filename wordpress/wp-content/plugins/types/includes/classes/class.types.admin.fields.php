 ...
 */
class Types_Admin_Fields extends Types_Admin
{
    ...
    function wpcf_hide_field_groups() {
        echo '<style>body.types_page_wpcf-edit-type label[for="field_groups-hide"],'
             . 'body.types_page_wpcf-edit-type #field_groups { display: none !important; }'
             . '</style>';
    }
}
