 ...
 */
class Types_Admin_Edit_Taxonomy extends Types_Admin
{
    ...
    public function init_admin()
    {
        ...
        /** This action is documented in includes/classes/class.types.admin.php  */
    ...
    public function form()
    {
        ...
        $form['name-singular'] = array(
            ...
            '#value' => isset( $this->ct['labels']['singular_name'] ) ? wp_kses_post($this->ct['labels']['singular_name']):'',
            '#validate' => array(
                'required' => array('value' => true),
                'maxlength' => array('value' => 30),
            ),
    ...
    function box_submitdiv()
    {
        ...
        $form['visibility-status'] = array(
            ...
            '#markup' => sprintf(
                ...
                __('Visibility in Admin Menu', 'wpcf'),
                (isset( $this->ct['public'] ) && strval( $this->ct['public'] ) == 'hidden') ? __('Hidden', 'wpcf'):__('Visible', 'wpcf')
            ),
            '_builtin' => true,
        );
        ...
        $form['visibility-choose-public'] = array(
            ...
            '#options' => array(
                sprintf(
                    ...
                    __('Visible', 'wpcf'),
                    __('Taxonomy is public', 'wpcf')
                ) => 'public',
                sprintf(
                    '<span class="title">%s</span> <span class="description">(%s)</span>',
                    __('Hidden', 'wpcf'),
                    __('users cannot directly edit data in this Taxonomy', 'wpcf')
                ) => 'hidden',
            ),
 ...
 <a href="#visibility" class="cancel-post-visibility hide-if-no-js button-cancel">Cancel</a>
    ...
    {
        if ( 'types_page_wpcf-edit-tax' != $screen_base ) {
            return;
        }
