 ...
 *
 */
class Types_Admin_Custom_Fields_Control_Table extends WP_List_Table
{
    /** ************************************************************************
    ...
    function __construct()
    {
        ...
        parent::__construct( array(
            'singular'  => __('Post Field', 'wpcf'),     //singular name of the listed records
            'plural'    => __('Post Fields', 'wpcf'),    //plural name of the listed records
    ...
    {
        global $wpdb;
        $per_page = $this->get_items_per_page('wpcf_cfc_per_page', 10);;
    ...
    function get_columns() {
        $columns = array(
            ...
            'cf_name' => __('Post Field Name', 'wpcf'),
            'group' => __('Field Group', 'wpcf'),
