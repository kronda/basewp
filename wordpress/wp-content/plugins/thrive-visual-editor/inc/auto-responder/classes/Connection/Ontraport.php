...
class Thrive_List_Connection_Ontraport extends Thrive_List_Connection_Abstract
{
     ...
     *
     * @return Thrive_Api_Ontraport
     */
    protected function _apiInstance()
    {
        return new Thrive_Api_Ontraport($this->param('app_id'), $this->param('key'));
    }
    ...
    protected function _getLists()
    {
        ...
        } catch (Thrive_Api_Ontraport_Exception $e) {
