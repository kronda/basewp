 ...
 */
class Thrive_Api_Postmark extends Thrive_Api_Postmark_ClientBase {
	...
	function sendEmail($from, $to, $subject, $htmlBody = NULL, $textBody = NULL,
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', '/email', $body));
	}
	...
	function sendEmailWithTemplate($from, $to, $templateId, $templateModel, $inlineCss = true,
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', '/email/withTemplate', $body));
	}
	...
	function sendEmailBatch($emailBatch = array()) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', '/email/batch', $final));
	}
	...
	function getDeliveryStatistics() {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/deliverystats'));
	}
	...
	function getBounces($count = 100, $offset = 0, $type = NULL,
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/bounces', $query));
	}
	...
	function getBounce($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/bounces/$id"));
	}
	...
	function getBounceDump($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/bounces/$id/dump"));
	}
	...
	function activateBounce($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('PUT', "/bounces/$id/activate"));
	}
	 ...
	 */
	function getServer() {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/server'));
	}
	...
	function editServer($name = NULL, $color = NULL, $rawEmailEnabled = NULL,
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('PUT', '/server', $body));
	}
	...
	function getOutboundMessages($count = 100, $offset = 0, $recipient = NULL,
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/messages/outbound', $query));
	}
	 ...
	 * @return Thrive_Api_Postmark_DynamicResponseModel
	 */
	function getOutboundMessageDetails($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/messages/outbound/$id/details"));
	}
	...
	function getOutboundMessageDump($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/messages/outbound/$id/dump"));
	}
	...
	function getInboundMessages($count = 100, $offset = 0, $recipient = NULL, $fromEmail = NULL,
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/messages/inbound', $query));
	}
	...
	function getInboundMessageDetails($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/messages/inbound/$id/details"));
	}
	...
	function bypassInboundMessageRules($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('PUT', "/messages/inbound/$id/bypass"));
	}
	...
	function retryInboundMessageHook($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('PUT', "/messages/inbound/$id/retry"));
	}
	...
	function getOpenStatistics($count = 100, $offset = 0, $recipient = NULL,
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/messages/outbound/opens', $query));
	}
	...
	function getOpenStatisticsForMessage($id, $count = 100, $offset = 0) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/messages/outbound/opens/$id", $query));
	}
	...
	function getOutboundOverviewStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound', $query));
	}
	...
	function getOutboundSendStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound/sends', $query));
	}
	...
	function getOutboundBounceStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound/bounces', $query));
	}
	...
	function getOutboundSpamComplaintStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound/spam', $query));
	}
	...
	function getOutboundTrackedStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound/tracked', $query));
	}
	...
	function getOutboundOpenStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound/opens', $query));
	}
	...
	function getOutboundPlatformStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound/opens/platforms', $query));
	}
	...
	function getOutboundEmailClientStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound/opens/emailclients', $query));
	}
	...
	function getOutboundReadTimeStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/stats/outbound/opens/readtimes', $query));
	}
	...
	function createTagTrigger($matchName, $trackOpens = true) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', '/triggers/tags', $body));
	}
	...
	function deleteTagTrigger($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('DELETE', "/triggers/tags/$id"));
	}
	...
	function searchTagTriggers($count = 100, $offset = 0, $matchName = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/triggers/tags', $query));
	}
	...
	function editTagTrigger($id, $matchName, $trackOpens = true) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('PUT', "/triggers/tags/$id", $body));
	}
	...
	function getTagTrigger($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/triggers/tags/$id"));
	}
	...
	function createInboundRuleTrigger($rule) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', '/triggers/inboundrules', $body));
	}
	...
	function listInboundRuleTriggers($count = 100, $offset = 0) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/triggers/inboundrules', $query));
	}
	...
	function deleteInboundRuleTrigger($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('DELETE', "/triggers/inboundrules/$id"));
	}
	...
	function deleteTemplate($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('DELETE', "/templates/$id"));
	}
	...
	function createTemplate($name, $subject, $htmlBody, $textBody) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', "/templates", $template));
	}
	...
	function editTemplate($id, $name = NULL, $subject = NULL, $htmlBody = NULL, $textBody = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('PUT', "/templates/$id", $template));
	}
	...
	function getTemplate($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/templates/$id"));
	}
	...
	function listTemplates($count = 100, $offset = 0) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/templates", $query));
	}
	...
	function validateTemplate($subject = NULL, $htmlBody = NULL, $textBody = NULL, $testRenderModel = NULL, $inlineCssForHtmlTestRender = true) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', "/templates/validate", $query));
	}
}
