 ...
 */
class Thrive_Api_Postmark_AdminClient extends Thrive_Api_Postmark_ClientBase {
	...
	function getServer($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/servers/$id"));
	}
	...
	function listServers($count = 100, $offset = 0, $name = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/servers/', $query));
	}
	...
	function deleteServer($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('DELETE', "/servers/$id"));
	}
	...
	function editServer($id, $name = NULL, $color = NULL,
		...
		$response = new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('PUT', "/servers/$id", $body));
		$response["ID"] = $id;
		return $response;
	}
	...
	function createServer($name, $color = NULL,
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', '/servers/', $body));
	}
	...
	function listSenderSignatures($count = 100, $offset = 0) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', '/senders/', $query));
	}
	...
	function getSenderSignature($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('GET', "/senders/$id"));
	}
	...
	function createSenderSignature($fromEmail, $name, $replyToEmail = NULL, $returnPathDomain = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', '/senders/', $body));
	}
	...
	function editSenderSignature($id, $name = NULL, $replyToEmail = NULL, $returnPathDomain = NULL) {
		...
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('PUT', "/senders/$id", $body));
	}
	...
	function deleteSenderSignature($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('DELETE', "/senders/$id"));
	}
	...
	function resendSenderSignatureConfirmation($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', "/senders/$id/resend"));
	}
	...
	function verifySenderSignatureSPF($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', "/senders/$id/verifyspf"));
	}
	...
	function requestNewSenderSignatureDKIM($id) {
		return new Thrive_Api_Postmark_DynamicResponseModel($this->processRestRequest('POST', "/senders/$id/requestnewdkim"));
	}
}
?>
