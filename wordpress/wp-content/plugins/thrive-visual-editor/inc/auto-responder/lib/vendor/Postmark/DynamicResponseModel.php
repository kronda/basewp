 ...
 * ```
 */
class Thrive_Api_Postmark_DynamicResponseModel extends Thrive_Api_Postmark_CaseInsensitiveArray {
	...
	public function __get($name) {
		...
		if ($value != NULL && is_array($value)) {
			$value = new Thrive_Api_Postmark_DynamicResponseModel($value);
		}
	...
	public function offsetGet($offset) {
		...
		if ($result != NULL && is_array($result)) {
			$result = new Thrive_Api_Postmark_DynamicResponseModel($result);
		}
		return $result;
	}
}
