...
<ul class="tve_menu">
    ...
    <li class="tve_btn_text tve_ed_btn tve_center tve_mousedown" data-ctrl="controls.mousedown.test_image" id="testimonial_image_btn"><?php echo __("Choose Testimonial Image", "thrive-cb") ?></li>
