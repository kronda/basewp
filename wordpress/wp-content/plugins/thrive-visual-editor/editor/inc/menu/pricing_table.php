...
<ul class="tve_menu">
    ...
    <li class="tve_text"><?php echo __("Move highlighted column:", "thrive-cb") ?></li>
    <li class="btn_alignment tve_alignment_left tve_click" data-ctrl="controls.pricing_table.move" data-dir="prev"><?php echo __("Left", "thrive-cb") ?></li>
    <li class="btn_alignment tve_alignment_right tve_click" data-ctrl="controls.pricing_table.move" data-dir="next"><?php echo __("Right", "thrive-cb") ?></li>
