 ...
 * Time: 16:59
 */
class Thrive_Api_AWeber_Collection extends Thrive_Api_AWeber_Response implements ArrayAccess, Iterator, Countable
{
     ...
     * @access public
     * @return Thrive_Api_AWeber_Entry
     */
     ...
     * @return Thrive_Api_AWeber_Entry(Resource) The new resource created
     */
    ...
    public function offsetGet($offset)
    {
        ...
        # we have an entry, cast it to an Thrive_Api_AWeber_Entry and return it
        $entry_url = $this->adapter->app->removeBaseUri($entry['self_link']);
        return new Thrive_Api_AWeber_Entry($entry, $entry_url, $this->adapter);
    }
