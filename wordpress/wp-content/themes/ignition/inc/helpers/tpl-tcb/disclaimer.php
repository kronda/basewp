<p><?php echo $options["website"] ?> is owned and operated by <?php echo $options["company"] ?> and may contain
    advertisements,
    sponsored content, paid insertions, affiliate links or other forms of monetization.</p>

<p><?php echo $options["website"] ?> abides by word of mouth marketing standards. We believe in honesty of relationship,
