...
<div class="thrive-page-settings" style="margin: 20px">
    ...
    <div>
        <div>
            <input type="radio" name="display_fonts" id="ttfm_google_fonts"
                   value="google_fonts"/> <?php _e("Show all fonts", 'thrive'); ?>
        </div>
        <div>
            <input type="radio" name="display_fonts" id="ttfm_prefered_fonts" value="prefered_fonts"
                   checked/> <?php _e("Recommended Fonts Only", 'thrive'); ?>
        </div>
        <div>
            <input type="radio" name="display_fonts" id="ttfm_safe_fonts"
                   value="safe_fonts"/> <?php _e("Web Safe Fonts", 'thrive'); ?>
        </div>
        <div>
        ...
        <a style="float: right" target="_blank"
           href="//www.google.com/fonts"><?php _e("View All Google Font Previews", 'thrive'); ?></a>
    </div>
    ...
    <div>
        <table>
            ...
            <tr>
                <td><?php _e("Line Height", 'thrive'); ?></td>
            ...
            <tr>
                <td><?php _e("Custom CSS", 'thrive'); ?></td>
                <td>
                    <textarea
    ...
    <hr>
    <input id="ttfm_save_font_options" type="button" value="<?php _e("Save", 'thrive'); ?>"
